...
import { billPeriodDays, calculateEnergyRate, effectiveSolarOffsetFactor, estimateBillConsumption, projectLinearGrid, projectRemainingGrid } from '../server/utilityBills.js';
...
assert.deepEqual(projectLinearGrid({ observedGridKwh: 600, elapsedHours: 240, totalHours: 720 }), { averageHourlyGridKwh: 2.5, averageDailyGridKwh: 60, projectedFutureGridKwh: 1200, projectedGridKwh: 1800 });
assert.equal(effectiveSolarOffsetFactor({ observedLoadKwh: 170, observedGridKwh: 120, observedSolarKwh: 60 }), 0.833);
